...
const BillModal = (props) => {
    const { open, handleCloseBill, bill } = props
                ...
                <Box sx={styles}>
                    <div className={clsx(style.invoice, style.invoice_to_print)}>
                        ...
                        <div className={clsx(style.customer_info)}>
                            <p>{`Khách sạn ${bill?.id_yourProduct?.name_product}`}</p>
                            <p>{`Địa chỉ: ${bill?.id_yourProduct?.adress_product}`}</p>
                            <p>{`Số điện thoại: ${bill?.id_yourProduct?.phone_product}`}</p>
                        </div>
                        <hr />
